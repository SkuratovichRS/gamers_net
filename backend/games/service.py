...
class Service:
    ...
    async def add_user_game(self, data: UserGameRequestSchema, user_id: int) -> CreateUserGameResponseSchema:
    ...
    async def get_user_games(self, user_id: int) -> list[GetUserGamesResponseSchema]:
        ...
        return [GetUserGamesResponseSchema.model_validate(user_game, from_attributes=True) for user_game in user_games]
